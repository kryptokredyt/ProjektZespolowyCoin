...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PZcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"PZcointools.com", "dnsseed.PZcointools.com"},
    {"PZcoinpool.org", "dnsseed.PZcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"PZcointools.com", "testnet-seed.PZcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PZcoin is probably already running."), addrBind.ToString().c_str());
        else
